...
/**
 * This is the item provider adapter for a {@link at.ac.tuwien.big.views.DomainModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DomainModelItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ViewsPackage.Literals.DOMAIN_MODEL__DOMAIN_MODEL_ELEMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ViewsPackage.Literals.DOMAIN_MODEL__DOMAIN_MODEL_ELEMENTS,
				 ViewsFactory.eINSTANCE.createClass()));

		newChildDescriptors.add
			(createChildParameter
				(ViewsPackage.Literals.DOMAIN_MODEL__DOMAIN_MODEL_ELEMENTS,
				 ViewsFactory.eINSTANCE.createDataType()));

		newChildDescriptors.add
			(createChildParameter
				(ViewsPackage.Literals.DOMAIN_MODEL__DOMAIN_MODEL_ELEMENTS,
				 ViewsFactory.eINSTANCE.createEnumeration()));

		newChildDescriptors.add
			(createChildParameter
				(ViewsPackage.Literals.DOMAIN_MODEL__DOMAIN_MODEL_ELEMENTS,
				 ViewsFactory.eINSTANCE.createAssociation()));
	}

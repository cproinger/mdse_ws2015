...
/**
 * This is the item provider adapter for a {@link at.ac.tuwien.big.views.Text} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TextItemProvider extends PropertyElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ViewsPackage.Literals.TEXT__FORMAT,
				 true,
				 false,
				 false,
	...
	protected void addLongPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Text_long_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Text_long_feature", "_UI_Text_type"),
				 ViewsPackage.Literals.TEXT__LONG,
				 true,
				 false,
				 false,

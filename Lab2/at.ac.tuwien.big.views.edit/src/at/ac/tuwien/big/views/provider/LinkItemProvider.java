...
/**
 * This is the item provider adapter for a {@link at.ac.tuwien.big.views.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Link_targetView_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Link_targetView_feature", "_UI_Link_type"),
				 ViewsPackage.Literals.LINK__TARGET_VIEW,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ViewsPackage.Literals.LINK__LABEL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Link)object).getLabel();

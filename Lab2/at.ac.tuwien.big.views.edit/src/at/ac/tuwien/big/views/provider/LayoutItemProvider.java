...
/**
 * This is the item provider adapter for a {@link at.ac.tuwien.big.views.Layout} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LayoutItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Layout_alignment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Layout_alignment_feature", "_UI_Layout_type"),
				 ViewsPackage.Literals.LAYOUT__ALIGNMENT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		LayoutStyle labelValue = ((Layout)object).getAlignment();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Layout.class)) {
			case ViewsPackage.LAYOUT__ALIGNMENT:

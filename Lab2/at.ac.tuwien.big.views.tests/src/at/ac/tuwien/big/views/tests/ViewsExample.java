...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>views</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewsExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.views"));
				DomainModel root = ViewsFactory.eINSTANCE.createDomainModel();
